...
exports.isIE = exports.getSuggestion = exports.getSuggestions = exports.countSuggestions = exports.makeMentionsMarkup = exports.getEndOfLastMention = exports.getMentions = exports.getPlainText = exports.applyChangeToValue = exports.findStartOfMentionInPlainText = exports.mapPlainTextIndex = exports.iterateMentionsMarkup = exports.getPositionOfCapturingGroup = exports.getComputedStyleLengthProp = exports.spliceString = exports.escapeRegex = undefined;
 ...
 */
var getComputedStyleLengthProp = exports.getComputedStyleLengthProp = function getComputedStyleLengthProp(forElement, propertyName) {
  var length = parseFloat(window.getComputedStyle(forElement, null).getPropertyValue(propertyName));
  return (0, _isFinite2.default)(length) ? length : 0;
};
 ...
 */
var getPositionOfCapturingGroup = exports.getPositionOfCapturingGroup = function getPositionOfCapturingGroup(markup, parameterName, regex) {
...
// `markupIteratee`.
var iterateMentionsMarkup = exports.iterateMentionsMarkup = function iterateMentionsMarkup(value, markup, textIteratee, markupIteratee, displayTransform, regex) {
...
var findStartOfMentionInPlainText = exports.findStartOfMentionInPlainText = function findStartOfMentionInPlainText(value, markup, indexInPlainText, displayTransform, regex) {
...
var applyChangeToValue = exports.applyChangeToValue = function applyChangeToValue(value, markup, plainTextValue, selectionStartBeforeChange, selectionEndBeforeChange, selectionEndAfterChange, displayTransform, regex) {
...
var getPlainText = exports.getPlainText = function getPlainText(value, markup, displayTransform, regex) {
  regex = regex || markupToRegex(markup);
  var idPos = getPositionOfCapturingGroup(markup, 'id', regex);
  var displayPos = getPositionOfCapturingGroup(markup, 'display', regex);
  var typePos = getPositionOfCapturingGroup(markup, 'type', regex);
...
var getMentions = exports.getMentions = function getMentions(value, markup, displayTransform, regex) {
  var mentions = [];
...
var getEndOfLastMention = exports.getEndOfLastMention = function getEndOfLastMention(value, markup, displayTransform, regex) {
