...
var propTypes = {
  ...
  inputRef: _propTypes2.default.oneOfType([_propTypes2.default.func, _propTypes2.default.shape({ current: typeof Element === 'undefined' ? _propTypes2.default.any : _propTypes2.default.instanceOf(Element) })]),
...
var MentionsInput = (_temp = _class = function (_React$Component) {
  ...
  this.renderSuggestionsOverlay = function () {
    ...
    var suggestionsNode = _react2.default.createElement(_SuggestionsOverlay2.default, {
  ...
  this.getPlainText = function () {
    return (0, _utils.getPlainText)(_this3.props.value || '', _this3.props.markup, _this3.props.displayTransform, _this3.props.regex);
  };
  ...
  this.handleChange = function (ev) {
    ...
    var newValue = (0, _utils.applyChangeToValue)(value, markup, newPlainTextValue, _this3.state.selectionStart, _this3.state.selectionEnd, ev.target.selectionEnd, displayTransform, regex);

    // In case a mention is deleted, also adjust the new plain text value
    newPlainTextValue = (0, _utils.getPlainText)(newValue, markup, displayTransform, regex);
    ...
    var startOfMention = (0, _utils.findStartOfMentionInPlainText)(value, markup, selectionStart, displayTransform, regex);
    ...
    var mentions = (0, _utils.getMentions)(newValue, markup, displayTransform, regex);
  ...
  this.updateSuggestionsPosition = function () {
    ...
    if (_this3.props.suggestionsPortalHost) {
      ...
      var caretHeight = (0, _utils.getComputedStyleLengthProp)(highlighter, 'font-size');
      ...
      left -= (0, _utils.getComputedStyleLengthProp)(suggestions, 'margin-left');
      position.top -= (0, _utils.getComputedStyleLengthProp)(suggestions, 'margin-top');
  ...
  this.updateMentionsQueries = function (plainTextValue, caretPosition) {
    ...
    var positionInValue = (0, _utils.mapPlainTextIndex)(value, markup, caretPosition, 'NULL', displayTransform, regex);
    ...
    var substringStartIndex = (0, _utils.getEndOfLastMention)(value.substring(0, positionInValue), markup, displayTransform, regex);
  ...
  this.addMention = function (suggestion, _ref) {
    ...
    var start = (0, _utils.mapPlainTextIndex)(value, markup, querySequenceStart, 'START', displayTransform, regex);
